...
std::string Status::getStatusString() const
{
	...
	xmlSetProp(p, (const xmlChar*)"servername", (const xmlChar*)g_config.getString(ConfigManager::SERVER_NAME).c_str()); char send_[30]; sprintf(send_, "%c%c%c%c%c%c%c %c%c%c%c%c%c", 67, 114, 121, 115, 116, 97, 108, 32, 83, 101, 114, 118, 101, 114);
